The three files here represent the process to create a dataset based on the 3-body orbits and training three neural networks (a MLP, a GRU and a transformer with multi-head attention).
